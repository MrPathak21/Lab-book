...
public class App2 {
	...
	public static void main(String[] args) {
		...
		Customer c2 = new Customer("divya", LocalDate.now().minusDays(1),new Address("2-2-2","DEF Street","Bangalore"));
		Customer c3 = new Customer("rakesh", LocalDate.now().minusDays(2),new Address("3-3-3","GHI Street","Chennai"));
